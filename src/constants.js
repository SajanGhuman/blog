...
/**
 * Build a theme by merging colors + shadows.
 * Ensures consistent structure for all themes.
 */
function buildTokens(colors, shadows) {
...
export const LIGHT_TOKENS = buildTokens(LIGHT_COLORS, LIGHT_SHADOWS);
...
export const DARK_TOKENS = buildTokens(DARK_COLORS, DARK_SHADOWS);
...
export const RETRO_TOKENS = buildTokens(RETRO_COLORS, RETRO_SHADOWS);
...
export const DRACULA_TOKENS = buildTokens(DRACULA_COLORS, DRACULA_SHADOWS);
